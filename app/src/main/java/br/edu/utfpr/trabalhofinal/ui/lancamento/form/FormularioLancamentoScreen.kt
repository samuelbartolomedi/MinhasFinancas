    ...
    Column(
        ...
        FormCheckbox(
            ...
            onCheckChanged = { newValue ->
                onStatusPagamentoAlterado(newValue)
            },
            enabled = !processando
        )
        Row {
...
private fun FormContentPreview() {
    TrabalhoFinalTheme {
        FormContent(
            processando = false,
            descricao = CampoFormulario("teste"),
            data = CampoFormulario(LocalDate.parse("20/05/2025")),
            valor = CampoFormulario("150.0"),
